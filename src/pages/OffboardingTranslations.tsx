...
const OffboardingTranslations = () => {
  ...
  const loadTranslations = async () => {
    ...
    try {
      const data = await fetchTranslations('offboarding');
    ...
    <div className="container mx-auto py-8">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold">Offboarding Module Translations</h1>
        </div>
        <Button 
          variant="outline" 
...
export default OffboardingTranslations;
